...
#################################### MANUAL EDITS #####################################
#######################################################################################
directory.loc[directory["park_code"] == "PAAV", "park_name"] = (
    "Pennsylvania Avenue National Historic Site"
)
directory.loc[directory["park_code"] == "JOFK", "park_name"] = (
    "John F. Kennedy Memorial Center for the Performing Arts"
)
directory.loc[directory["park_code"] == "KICA", "park_name"] = (
    "Kings Canyon National Park"
)
directory.loc[directory["park_code"] == "NCPC", "park_name"] = (
    "National Mall and Memorial Parks"
)
directory.loc[directory["park_code"] == "NCPE", "park_name"] = (
    "National Capital Parks-East"
)
directory.loc[directory["park_code"] == "OBRI", "park_name"] = (
    "Obed Wild and Scenic River"
)
directory.loc[directory["park_code"] == "PRPA", "park_name"] = "President's Park"
directory.loc[directory["park_code"] == "SEQU", "park_name"] = "Sequoia National Park"
directory.loc[directory["park_code"] == "JEFM", "park_name"] = (
    "Thomas Jefferson Memorial"
)
# NPS site incorrectly goes to Grand Teton NPS site
directory.loc[directory["park_code"] == "JODR", "park_name"] = (
    "John D. Rockefeller Jr. Memorial Parkway"
)
# NPS site incorrectly goes to North Cascade NPS site
directory.loc[directory["park_code"] == "LACH", "park_name"] = (
    "Lake Chelan National Recreation Area"
)
# NPS site incorrectly goes to North Cascade NPS site
directory.loc[directory["park_code"] == "ROLA", "park_name"] = (
    "Ross Lake National Recreation Area"
)
# NPS site incorrectly goes to North Cascade NPS site
directory.loc[directory["park_code"] == "FOCA", "park_name"] = (
    "Fort Caroline National Memorial"
)

# Remove NACA and NAVC from directory.
...
############################# Write data to file. #############################
###############################################################################
visits_df.to_csv("unit_visits.csv", index=False)
